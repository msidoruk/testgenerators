...
namespace EPS.DtoMaker.Engine
{
    ...
    public class DtoMakerModel
    {
        ...
        public class ModelEntityChildrenFinder
        {
            ...
            private void CreatePath(int tailEntityId, ConnectedEntityInfo currentConnectedEntityInfo)
            {
                ...
                {
                    path.Add(new PathItem(workPathItem.ModelEntity, workPathItem.ConnectedEntityInfo));
                }
    ...
    {
        public int Id => ModelEntity.Id;
        public string Name => ModelEntity.EntityName;

        public ModelEntity ModelEntity { get; private set; }
        public ConnectedEntityInfo ConnectedEntityInfo { get; private set; }

        public PathItem(ModelEntity modelEntity, ConnectedEntityInfo currentConnectedEntityInfo)
        {
