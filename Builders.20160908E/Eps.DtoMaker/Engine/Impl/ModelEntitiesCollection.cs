...
namespace EPS.DtoMaker.Engine.Impl
{
    public class ModelEntitiesCollection : ListBasedCollection<ModelEntity>
    {
        ...
        public ModelEntity AppendEntity(DtoMakerContext context, ActionsApplicationHistoryItem actionsApplicationHistoryItem)
        {
            ModelEntity newModelEntity = new ModelEntity(context, actionsApplicationHistoryItem);
            _underlyingList.Add(newModelEntity);
